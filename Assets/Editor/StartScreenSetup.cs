...
public static class StartScreenSetup
{
    ...
    private const string GameSceneName = "HeroKnightSandbox";
    ...
    public static void BuildStartScreen()
    {
        ...
        playSO.FindProperty("sceneName").stringValue = GameSceneName;
    ...
    // StartScreen must boot first - inserted at index 0 regardless of whether
    // HeroKnightSandboxSetup.FinalizeProjectSettings() (which registers
    // HeroKnightSandbox.unity) has already run or runs afterward.
